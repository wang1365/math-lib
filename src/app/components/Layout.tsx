...
export default function Layout({ children }: LayoutProps) {
  ...
  const navigation = [
    ...
    { name: '学习资源', href: '/resources', icon: BookOpen },
    { name: '数学分支', href: '/branches', icon: Library },
    { name: '工具', href: '/tools', icon: Calculator },
    { name: '计算器', href: '/calculator', icon: Calculator },
    { name: '公式示例', href: '/examples', icon: Hash },
  ]
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-300 mb-4">
                为数学爱好者、学生和研究者提供全面的数学学习资源和工具。
              </p>
              <div className="text-sm text-gray-400">
                <p>© 2024 数学资源库. 保留所有权利.</p>
              </div>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/resources" className="group flex items-center text-gray-300 hover:text-white transition-all duration-300"><span className="w-2 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>学习资源</Link></li>
                <li><Link href="/branches" className="group flex items-center text-gray-300 hover:text-white transition-all duration-300"><span className="w-2 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>数学分支</Link></li>
                <li><Link href="/tools" className="group flex items-center text-gray-300 hover:text-white transition-all duration-300"><span className="w-2 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>数学工具</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
